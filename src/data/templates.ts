...
export const templates: Template[] = [
  {
    ...
    description:
      "Express.js server with JWT authentication, OTP verification, and complete user management",
    stack: "express",
    features: [
      "JWT Auth",
      "OTP Verification",
  ...
  },
  {
    ...
    description:
      "Basic Express.js REST API with routing, middleware, and error handling",
    stack: "express",
