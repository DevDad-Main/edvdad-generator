      ...
      <div className="relative max-w-7xl mx-auto text-center z-10">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 glass-panel rounded-full glow-accent-sm">
            ...
            <span className="text-sm font-mono text-muted-foreground">Production-Ready Templates</span>
          </div>

          {/* Main Heading */}
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight">
            <span className="block text-foreground">Ship Backend</span>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Generate production-ready backend templates with authentication, routing, 
            and database integration. Zero boilerplate. Full control.
          </p>
